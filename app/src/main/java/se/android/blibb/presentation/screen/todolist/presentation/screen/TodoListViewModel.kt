...
import se.android.blibb.presentation.screen.todolist.repository.RoomTodoRepository
import se.android.blibb.presentation.screen.todolist.repository.SettingsRepository
...
class TodoListViewModel @Inject constructor(
    ...
    fun changeTodoPaidState(todoItem: TodoItem, value: Boolean) {
        val newTodoItem = todoItem.copy(isPaid = value)
        viewModelScope.launch {
            todoRepository.updateTodo(newTodoItem)
        }
    }
